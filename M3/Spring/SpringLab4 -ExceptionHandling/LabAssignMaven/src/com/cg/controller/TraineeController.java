...
public class TraineeController {
	...
	public String loginCheck(HttpServletRequest req,HttpServletResponse res)throws LoginException{
		String name=req.getParameter("uname");
		String pass=req.getParameter("pass");
		
		if(name.equals("vishal") && pass.equals("123")){
	...
	public String deleteConfirmTrainee(HttpServletRequest req,Model theModel)throws InvalidIdException{
	...
	public String updateFormTrainee(HttpServletRequest req,Model theModel)throws InvalidIdException{
		int id=Integer.parseInt(req.getParameter("TraineeId"));
		Optional<Trainee>opt=traineeService.searchTrainee(id);
		if(!opt.isPresent())
			throw new InvalidIdException();
	...
	public String showByID(HttpServletRequest req,Model theModel)throws InvalidIdException{
		int id=Integer.parseInt(req.getParameter("TraineeId"));
		Optional<Trainee> opt=traineeService.searchTrainee(id);
		if(!opt.isPresent())
			throw new InvalidIdException();
